...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002072363863').split()]
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002034648005')
