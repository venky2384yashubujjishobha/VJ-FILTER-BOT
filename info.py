...
API_ID = int(environ.get('API_ID', '23867351'))
API_HASH = environ.get('API_HASH', 'f7b417fdb81683af78660aafbd1b5cfa)
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5201558239').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002061503651').split()]
...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002128338466')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None
NO_RESULTS_MSG = bool(environ.get("NO_RESULTS_MSG", False))

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Yashuallu:mYFD5BqMxTGluZ6b@cluster0.ihilpaa.mongodb.net/?retryWrites=true&w=majority")
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Moviessgallery')
TUTORIAL = environ.get('TUTORIAL', '')
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'Hello My Dear Friends ❤️')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001995015348)
...
URL = "https://moviessgallery-bot-ecrz.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://moviessgallery-bot-ecrz.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://moviessgallery-bot-ecrz.onrender.com/".format(FQDN)
else:
    URL = "https://moviessgallery-bot-ecrz.onrender.com/".format(FQDN)
