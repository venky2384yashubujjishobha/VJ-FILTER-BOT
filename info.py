...
URL = "https://moviessfiles.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://moviessfiles.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://moviessfiles.onrender.com/".format(FQDN)
else:
    URL = "https://moviessfiles.onrender.com/".format(FQDN)
